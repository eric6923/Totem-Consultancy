  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="w-full px-4">
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 w-full justify-center mt-8 md:mt-20">
          ...
          <div className="flex justify-start w-full ml-0 md:ml-20 mb-10 md:mb-40 mt-4 md:mt-10">
