    ...
    <>
      ...
      <div className="py-16 px-6 bg-[#343434] text-white">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-white">Receive latest news, updates and many other news every week.</p>
        </div>
        <div className="flex justify-center mt-8">
          <div className="relative flex w-full max-w-sm"> {/* Reduced from max-w-md to max-w-sm */}
            <input
              placeholder="Enter your email address"
              className="w-full px-6 py-4 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-900 pr-16 text-gray-800" /* Increased padding */
              type="email"
            />
            <button 
      ...
      <footer className="bg-[#F9F6F0] text-gray-900 py-12 px-6">
        <div className="flex flex-wrap justify-between space-y-8 md:space-y-0">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-lg font-bold">+91 82784 16000, +91 93508 51909</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/3">
            ...
            <ul className="space-y-2">
              {['Home', 'About', 'Services', 'Projects', 'Gallery', 'Contact'].map((page) => (
                <li key={page}>
                  <a
        ...
        <div className="flex flex-col md:flex-row justify-between text-lg font-bold">
          ...
          <div className="space-x-6 mt-4 md:mt-0">
            {['Home', 'Team', 'Privacy & Policy', 'Contact'].map((item) => (
              <a
                key={item}
