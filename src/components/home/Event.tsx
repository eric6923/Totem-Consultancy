    ...
    <div className="py-12 px-6 bg-[#FDF8F3] min-h-screen">
      ...
      <div className="text-center mt-8">
        <img
          ...
          className="w-full object-cover rounded-2xl h-auto md:h-[368px]"
        />
      </div>

      {/* Features Section */}
      <div className="bg-[#FFEFD2] p-8 text-black w-full flex flex-col md:flex-col justify-between items-start rounded-2xl mt-12 space-y-8">
        {/* Why We! Title */}
        <div className="w-full text-center md:text-left mb-4">
          <h2 className="text-3xl font-bold text-gray-900">Why We!</h2>
        </div>

        {/* Features */}
        <div className="flex flex-wrap md:flex-row justify-between items-start w-full gap-6 md:gap-8">
          {/* Easy Peasy Pricing */}
          <div className="flex items-center space-x-6 w-full md:w-1/3">
            <img src={PricingIcon} alt="Pricing Icon" className="w-20 h-20" />
            <div>
          ...
          {/* Unique Design */}
          <div className="flex items-center space-x-6 w-full md:w-1/3">
            <img src={DesignIcon} alt="Design Icon" className="w-20 h-20" />
            <div>
          ...
          {/* Achieve Milestone */}
          <div className="flex items-center space-x-6 w-full md:w-1/3">
            <img src={MilestoneIcon} alt="Milestone Icon" className="w-20 h-20" />
            <div>
