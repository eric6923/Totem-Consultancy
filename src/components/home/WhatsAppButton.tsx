    ...
    <div className="fixed bottom-3 left-0 z-50">
      {showChat && (
        <div className="relative inline-flex items-center ml-4">
          <a 
            className="bg-white md:px-4 md:py-2 px-3 py-1 rounded-2xl border-black border-1 shadow-[3px_3px_0_#22c55e] mr-4 "
          ...
          <button
            ...
            className="bg-black rounded-full p-1 text-white hover:bg-gray-200 transition-colors"
