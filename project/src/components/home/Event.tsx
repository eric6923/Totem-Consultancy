...
const Event: React.FC = () => {
  return (
    <div className="py-12 px-6 bg-[#FDF8F3] min-h-screen">
      ...
      {/* Features Section */}
      <div className="bg-[#FFEFD2] p-8 text-black w-full flex flex-col md:flex-row justify-between items-start rounded-2xl mt-12 space-y-8 md:space-y-0 md:space-x-8">
        {/* Easy Peasy Pricing */}
