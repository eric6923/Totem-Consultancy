...
const TaskManagementPage = () => {
  ...
  const fetchTasks = async () => {
    try {
      const response = await fetch('https://bihar-innovation-omega.vercel.app/api/crm/tasks');
  ...
  const fetchFormData = async () => {
    try {
      const [projectsRes, managersRes, teamMembersRes] = await Promise.all([
        fetch('https://bihar-innovation-omega.vercel.app/api/crm/projects'),
        fetch('https://bihar-innovation-omega.vercel.app/api/crm/users?role=manager'),
        fetch('https://bihar-innovation-omega.vercel.app/api/crm/users?role=teammember')
      ]);
