import {
  ...
  export default function Dashboard(): JSX.Element {
    ...
    // Custom tooltip formatter to handle long labels on mobile
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={monthlyData} margin={{ top: 5, right: 5, left: -30, bottom: 5 }}>
                  ...
                  <Legend 
                    ...
                    iconType="circle"
                  />
                  <Line type="monotone" dataKey="tasksCreated" stroke="#6366F1" strokeWidth={2} dot={{ r: 2 }} name="Created" />
                  <Line type="monotone" dataKey="tasksCompleted" stroke="#22C55E" strokeWidth={2} dot={{ r: 2 }} name="Completed" />
                  <Line type="monotone" dataKey="tasksPending" stroke="#EF4444" strokeWidth={2} dot={{ r: 2 }} name="Pending" />
                </LineChart>
              </ResponsiveContainer>
            </ChartContainer>
          </div>
